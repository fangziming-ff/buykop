...
@Mongo(code = RPageInfBatch.table, sys = Constants.current_sys, display = "页面接口", retainDays = 0, defaultOrderByField = "")
public class RPageInfBatch extends Entity {
	...
	protected static final String table = "M_PAGE_INF_BATCH";
	...
	@PK
	@FK( table = DiyInfBatch.class)
	@Column(dbLen = DBLen.idLen, displayName = "批处理接口编号", isNotNull = false, label = "",fieldType=2)
